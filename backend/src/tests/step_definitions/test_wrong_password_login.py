...
def mock_wrong_password_login_service_response(name_check: str, username_check: str, email_check: str, cpf_check: str):
...
def post_wrong_password_login(client, context, url_requisition: str, username: str, password: str):
...
def check_wrong_password_login_status_code(context, status_code: str): 
...
def check_wrong_password_login_response(context, resposta: str):
