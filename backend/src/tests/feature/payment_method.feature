Feature: Cadastrar forma de pagamento
    ...
    Scenario: Cadastrar forma de pagamento (limite atingido)
        ...
        When uma requisição "POST" for enviada para "/payment/pedro123/add" com tipo "debito" e id "1346 7908 7542 1346"
    ...
    Scenario: Cadastrar forma de pagamento já cadastrada
        ...
        When uma requisição "POST" for enviada para "/payment/yasmimvso/add" com tipo "pix" e id "None"
    ...
    Scenario: Atualizar forma de pagamento
        ...
        When uma requisição "PUT" for enviada para "/payment/rafaael/update" com tipo "pix" e id "None"
        Then o status da resposta deve ser "200"
    ...
    Scenario: Tentar atualizar dados inválidos
        ...
        When uma requisição "PUT" for enviada para "/payment/saran/update" com tipo "debito" e id "None"
        Then o status da resposta deve ser "400"
    ...
    Scenario: Deletar forma de pagamento (operação sucedida)
        ...
        When uma requisição "DELETE" for enviada para "/payment/yoni/delete"
        Then o status da resposta deve ser "200"
