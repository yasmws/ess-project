...
Scenario: Cadastro de usuário
Given O banco de dados do sistema não tem cadastrado um usuário com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
When Uma requisição POST é enviada para “/users/create” com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
Then O status da resposta deve ser “201”
And A resposta deve conter “Usuário criado!”

Scenario: Usuário tentou cadastrar um nome com números
Given O banco de dados do sistema não tem cadastrado um usuário com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
When Uma requisição POST é enviada para “/users/create” com Nome “Paulo12”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
...
Given O banco de dados do sistema não tem cadastrado um usuário com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
When Uma requisição POST é enviada para “/users/create” com Nome “Paulo”, Username “plop”, Email “plopcin.ufpe.br” , CPF “12345678905” e senha “1234678”
Then O status da resposta deve ser “400”
And A resposta deve conter “Esse email é inválido.”

Scenario: Usuário tentou cadastrar um CPF em formato inválido
Given O banco de dados do sistema não tem cadastrado um usuário com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
When Uma requisição POST é enviada para “/users/create” com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “012345678905” e senha “1234678”
Then O status da resposta deve ser “400”
...
Given O banco de dados do sistema não tem cadastrado um usuário com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “1234678”
When Uma requisição POST é enviada para “/users/create” com Nome “Paulo”, Username “plop”, Email “plop@cin.ufpe.br” , CPF “12345678905” e senha “123467”
Then O status da resposta deve ser “400”
...
Given O banco de dados do sistema tem cadastrado um usuário com Nome “Pedro”, Username “phagp”, Email “phagp@cin.ufpe.br” , CPF “12345678912” e senha “1234678”
